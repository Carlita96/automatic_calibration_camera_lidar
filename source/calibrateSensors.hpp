...
#ifndef CALIBRATION_SOURCE_CALIBRATESENSORS_H_
#define CALIBRATION_SOURCE_CALIBRATESENSORS_H_
...
class CalibrateSensors
{
    ...
    private:
        ...
        bool mAnalysisDataSaveObservations;
        // Spherical target
        double mSphericalTargetRadius;
        // Output files directory
        std::string mOutputAnalysisFilesDirectory;
        std::string mOutputCalibrationParamsDirectory;
...
#endif // CALIBRATION_SOURCE_CALIBRATESENSORS_H_ 